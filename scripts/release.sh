...
#   - a branch other than main (or RELEASE_BRANCH), or one behind its remote
...
# The branch releases are cut from. main in the service repositories; a
# repository created with another default says which.
main="${RELEASE_BRANCH:-main}"
